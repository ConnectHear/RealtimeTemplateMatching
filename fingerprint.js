...
// Note: The free `geoip-lite` database is not always up-to-date and may return null for some IPs.
// In a production environment, you might consider a paid service or a regularly updated database.
...
const requestData1 = {
    // Use Google's Public DNS IP - Located in the US
    ipAddress: "8.8.8.8",
    userAgentString: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36",
    deviceId: null
};
...
const requestData2 = {
    // A different public IP in the same /24 subnet as the first one
    ipAddress: "8.8.8.200",
    userAgentString: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36",
    deviceId: null
};
...
//  node node_modules/geoip-lite/scripts/updatedb.js license_key=YOUR_NEW_KEY_HERE